...
class Menu:
    def __init__(self, surface):
        ...
        self.click_sound = pygame.mixer.Sound(f"Assets/Sounds/slap.mp3")
    ...
    def update(self):
        self.draw()
        if ui.button(self.surface, SCREEN_HEIGHT - BUTTONS_SIZES[1]*1.2, "START", click_sound=self.click_sound):
            return "game"
